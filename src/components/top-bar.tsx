...
export function TopBarComponent() {
    ...
    return (
        <div className="relative">
            <div
                className="bg-gradient-to-r from-orange-400 to-orange-500 text-white p-4 shadow-lg transition-all duration-300 ease-in-out">
                <div className="container mx-auto flex items-center justify-between">
                    <div
                        className="text-2xl font-bold font-sans transition-transform duration-300 ease-in-out hover:scale-105">
                        Q3
                    </div>
